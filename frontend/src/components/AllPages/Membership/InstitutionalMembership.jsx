...
function InstitutionalMembership() {
    return (
        <>
            ...
            <section class="max-w-6xl mx-auto px-4 py-10 bg-gray-50 rounded-lg shadow-lg">
                <h2 class="text-4xl font-bold text-center text-gray-800 mb-6">Institutional Membership with MTTF</h2>
                ...
                <div class="space-y-10">
                    <h3 class="text-3xl font-semibold text-gray-800 text-center mb-4">Benefits of Institutional Membership</h3>
                    <div class="mt-4 border-l-4 border-blue-500 pl-4 space-y-8">

                        {/* <!-- Access to Resources --> */}
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Access to Resources:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Professional Development:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Networking Opportunities:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Collaboration and Partnerships:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Recognition and Awards:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Community Engagement:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <h4 class="text-xl font-semibold text-blue-600">Exclusive Member Benefits:</h4>
                            <ul class="list-disc list-inside ml-6 text-gray-700 space-y-2">
            ...
            <section class="bg-gradient-to-b from-blue-50 to-white p-10 px-4 md:px-10 lg:px-20 rounded-lg shadow-md mx-auto mt-12">
                <h2 class="text-3xl font-bold text-center text-blue-900 mb-8">Institutional Membership Fee</h2>
                <p class="text-gray-800 text-center mb-10  lg:mx-40 leading-relaxed">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="p-6 bg-gray-50 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-2xl">
                        <h3 class="text-xl font-semibold text-blue-800 mb-2">Small Institutions</h3>
                        <p class="text-gray-600 text-sm mb-1">(up to 100 members)</p>
                        <p class="text-lg font-bold text-blue-900">Annual Fee: INR 50,000</p>
                    </div>

                    <div class="p-6 bg-gray-50 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-2xl">
                        <h3 class="text-xl font-semibold text-blue-800 mb-2">Medium Institutions</h3>
                        <p class="text-gray-600 text-sm mb-1">(101 to 500 members)</p>
                        <p class="text-lg font-bold text-blue-900">Annual Fee: INR 100,000</p>
                    </div>

                    <div class="p-6 bg-gray-50 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-2xl">
                        <h3 class="text-xl font-semibold text-blue-800 mb-2">Large Institutions</h3>
                        <p class="text-gray-600 text-sm mb-1">(over 500 members)</p>
                        <p class="text-lg font-bold text-blue-900">Annual Fee: INR 200,000</p>
                    </div>
                </div>

                <p class="text-gray-800 text-center mt-12 leading-relaxed">
