                ...
                <div className="  w-full lg:w-[80%] lg:mx-auto">
                    ...
                    {show.IEARGAward2025 && (
                        <div class="bg-white p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">IEARG Awards 2025</h2>
                            <p>
                    ...
                    {show.WhyIEARGAwards && (
                        <div class="bg-gray-50 p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">Why IEARG Awards?</h2>
                            <p>
                            ...
                            <h3 class="text-xl font-semibold">Nomination and Selection Process</h3>
                            ...
                            <h3 class="text-xl font-semibold">Judging Criteria</h3>
                            <ul class="list-disc pl-5 space-y-2">
                    ...
                    {show.PanelOfJudges && (
                        <div class="bg-gray-50 p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">Chairperson</h2>
                            <p>
                                <strong>Prof. (Dr.) Praveen Agarwal</strong>, Vice-Principal & Chief Coordinator-International Relations, Anand International College of Engineering, Jaipur, India. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                            </p>
                            <h2 class="text-2xl font-semibold">Co-Chairperson(s)</h2>
                            <ul class="list-disc pl-5 space-y-2">
                                <li>
                                    <strong>Prof. (Dr.) Dumitru Baleanu</strong>, Lebanese American University, Beirut, Professor at Institute of Space Sciences, Bucharest, Romania. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) V.P. Saxena</strong>, Ex-Vice Chancellor Jiwaji University, Gwalior, Madhya Pradesh, India. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                            </ul>
                            <h2 class="text-2xl font-semibold">Panel Member(s)</h2>
                            <ul class="list-disc pl-5 space-y-2">
                                <li>
                                    <strong>Prof. (Dr.) Essam H. Houssein</strong>, Professor of Artificial Intelligence, Dean of Faculty of Computers & Information, Minia University, Minia 61519, Egypt. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Valentina E. Balas</strong>, Faculty of Engineering, Aurel Vlaicu University of Arad / Academy of Romanian Scientists, ROMANIA. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Zakia Hammouch</strong>, Department of Medical Research, China Medical University Hospital, Taichung 40402, Taiwan & Department of Sciences Ecole Normale Superieure, Moulay Ismail University of Meknes, Morocco. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Ali A. Taani</strong>, Associate Professor, Physics Department-Al Balqa Applied University, Jordan. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Ezekiel Ayoola</strong>, Deputy Vice-Chancellor (Administration), University of Ibadan, Nigeria. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Shilpi Jain</strong>, Department Of Mathematics, Poornima College of Engineering, Jaipur-302022, India. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Prof. (Dr.) Pooja</strong>, Dean, Faculty of Engineering and Technology, Sharda University Uzbekistan. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Dr. Jaswinder Pal</strong>, Professor of Physics, Baba Farid College, Bathinda affiliated to Punjabi University, Patiala, India & Co-Founder at MTTF, India. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                                <li>
                                    <strong>Dr. Gurmej Singh Sandhu</strong>, Professor of Mathematics, Mata Sahib Kaur Girls College, Bathinda affiliated to Punjabi University, Patiala, India & Co-Founder at MTTF, India. <a href="https://scholar.google.com" class="text-blue-500 hover:underline">Google Scholar Profile</a>
                                </li>
                            </ul>
                        </div>
                    )}
                    {show.ImportantDates && (
                        <div class="bg-gray-50 p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">Important Dates for EARG Awards 2025</h2>
                            <ul class="list-disc pl-5 space-y-2">
                    ...
                    {show.HowToApply && (
                        <div class="bg-gray-50 p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">Application Process for EARG Awards 2025</h2>
                    ...
                    {show.CallForNomination && (
                        <div class="bg-white p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">Call for Nomination of International EARG Awards 2025</h2>
                            ...
                            <h3 class="text-xl font-semibold">Steps to Apply</h3>
                            <ol class="list-decimal pl-5 space-y-2">
                                <li>Click on registration for nomination.</li>
                    ...
                    {show.CategoriesAndEligibility && (
                        <div class="bg-white p-8 rounded-lg shadow-lg space-y-6">
                            <h2 class="text-2xl font-semibold">EARG Award Categories and Eligibility</h2>
                            <p>
                            ...
                            <h3 class="text-xl font-semibold">1. Lifetime Achievement Award in Academia and Research</h3>
                            <p>
                            ...
                            <h4 class="font-semibold">Eligibility Criteria:</h4>
                            ...
                            <h3 class="text-xl font-semibold">2. Excellence in Academic Leadership Award</h3>
                            <p>
                            ...
                            <h3 class="text-xl font-semibold">3. Excellence in Research and Development</h3>
                            <p>
                            ...
                            <h4 class="font-semibold">Awards Categories:</h4>
                            <ul class="list-disc pl-5 space-y-1">
