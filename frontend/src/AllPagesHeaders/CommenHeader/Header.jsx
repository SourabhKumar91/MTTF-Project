    ...
    return (
        <div className='flex  flex-col md:flex-row justify-center items-center gap-10 mt-36 md:mb-20 mb-12  text-[#FFFFFF]'>
            ...
            <div className='flex-1 md:text-left  text-center px-6  '>
                ...
                {button && (
                    <div class="rounded-md shadow flex items-center justify-center mt-8">
                        <button href=""
                            class=" w-[80%] lg:w-[50%] px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-blue-500 border border-transparent rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue md:py-4 md:text-lg md:px-10">
                            {button}
                        </button>
                    </div>
                )}
