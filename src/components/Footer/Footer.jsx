...
function Footer() {
    const ourCompanyLink = ["About","Mission and Visition","leadership and Advisory","Life and MTTF","Govering Body","Mou/Collaboration"]
            ...
            <footer class="text-gray-600 body-font   border-t-4 ">
                <div class="container  px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <Logo/>
                        <p class="mt-2 text-sm text-gray-500">The MathTech Thinking Foundation (MTTF) is registered under Section 8 of the Companies Act 2013, Ministry of Corporate Affairs, Government of India.</p>
                    </div>
